            ...
            dbref2.orderByChild("classname").addChildEventListener(new ChildEventListener() {
              ...
              public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                Button adminStudentDetailsSubjectsBtn = findViewById(
                    R.id.adminStudentDetailsSubjectsBtn);
                adminStudentDetailsSubjectsBtn.setOnClickListener(new View.OnClickListener() {
                  ...
                  public void onClick(View v) {
                    ...
                    Intent i = new Intent(getApplicationContext(),
                        AdminStudentSubjectListActivity.class);
                  ...
                  public void onClick(View v) {
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                      ...
                      public void onClick(DialogInterface dialog, int which) {
                        ...
                        DatabaseReference dbrefTo = db.getReference().child("Student").child(schID)
                            .child(classIDTo).child(sID);
