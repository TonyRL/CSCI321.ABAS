        ...
        UserQueryClass(new FirebaseCallBack() {
            ...
            public void onCallBack(UserModel userModel) {
                ...
                firebaseRecyclerAdapter =
                        new FirebaseRecyclerAdapter<ListOfSubjectsModel, ListOfSubjectsModelViewHolder>(options) {
                            @Override
                            protected void onBindViewHolder(@NonNull ListOfSubjectsModelViewHolder holder, int position, @NonNull ListOfSubjectsModel model) {
                                //bind object
                            ...
                            @NonNull
                            @Override
                            public ListOfSubjectsModelViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                adminSubjectAddBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(AdminSubjectsListActivity.this, THEME_DEVICE_DEFAULT_DARK);
        ...
        public void setSubjectname(String subjectname) {
            ...
            subjectNameBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent i = new Intent(getApplicationContext(), AdminSubjectSettingsActivity.class);

                    //Passing 'subjectID','schID' to AdminSettingsAcitivity
                    Bundle args = new Bundle();
