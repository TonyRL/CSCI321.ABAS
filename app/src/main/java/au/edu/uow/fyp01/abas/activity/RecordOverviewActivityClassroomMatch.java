...
public class RecordOverviewActivityClassroomMatch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference Classroom_User_Matching_ABAS_UIDDBREF = FirebaseDatabase.getInstance().getReference()
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<RecordOverActivityClassroomMatchRecyclerClass, RecordOverviewActivityClassroomMatchHolder>(firebaseRecyclerOptions) {
            @Override
            protected void onBindViewHolder(@NonNull RecordOverviewActivityClassroomMatchHolder holder, int position, @NonNull final RecordOverActivityClassroomMatchRecyclerClass model) {
                                        ...
                                        for(DataSnapshot snapSubmissionID: dataSnapshot.getChildren()) {
                                            if(snapSubmissionID.getKey().equals(model.getClassroom_Submission_ID())) {
                                                ...
                                                DatabaseReference newDBREF = FirebaseDatabase.getInstance()
                                                        ...
                                                        .child(FirebaseAuth.getInstance().getCurrentUser().getUid());
                                                newDBREF.child(Classroom_Submission_ID).updateChildren(submissionDetailsMap, new DatabaseReference.CompletionListener() {
                                                    @Override
                                                ...
                                                Classroom_User_Matching_ABAS_UIDDBREF.child(model.getClassroom_Submission_ID()).removeValue(new DatabaseReference.CompletionListener() {
                                                    @Override
                                                    public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                                ...
                                                Map pushAssign = new HashMap();
                                                    ...
                                                    DatabaseReference ref = FirebaseDatabase.getInstance().getReference()
                                                            ...
                                                            ref.child(model.getClassroom_Submission_ID()).updateChildren(pushAssign, new DatabaseReference.CompletionListener() {
                                                                @Override
                                                                public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                                                                }
                                                            });
