...
public class RecordGradesHistoryActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressBar recordGradesHistoryProgressBar = findViewById(R.id.recordGradesHistoryProgressBar);
        ...
        firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<RecordModel, RecordModelViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull RecordModelViewHolder holder, int position, @NonNull RecordModel model) {
                        //bind object
