...
public class SchoolListActivity extends AppCompatActivity {
  ...
  @BindView(R.id.schoolListRecyclerView)
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    UserQueryClass(new FirebaseCallBack() {
      ...
      public void onCallBack(UserModel userModel1) {
        ...
        adapter = new FirebaseRecyclerAdapter<SchoolInfoModel, SchoolInfoModelViewHolder>(options) {
          @Override
  ...
  public class SchoolInfoModelViewHolder extends RecyclerView.ViewHolder {
    ...
    @BindView(R.id.modelSingleBtn)
    Button schoolBtn;
    String schID;
    String schoolname;

    SchoolInfoModelViewHolder(View itemView) {
      super(itemView);
    ...
    public void setSchoolname(final String schoolname) {
      ...
      schoolBtn.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {
          ...
          String tempstring = "Send a request to " + schoolname + " ?";
