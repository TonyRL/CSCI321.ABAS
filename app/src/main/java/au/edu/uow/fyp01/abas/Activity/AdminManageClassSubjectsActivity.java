...
public class AdminManageClassSubjectsActivity extends Activity {
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        ...
                        addSubjectToClassBtn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                AlertDialog.Builder builder1 = new AlertDialog.Builder(AdminManageClassSubjectsActivity.this);
                                        ...
                                        new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int id) {
                                                ...
                                                try {
                                                    ...
                                                    addToDatabase.put("subjectname", subjectSpinner.getSelectedItem().toString());
