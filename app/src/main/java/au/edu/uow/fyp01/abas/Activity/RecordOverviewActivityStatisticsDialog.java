...
public class RecordOverviewActivityStatisticsDialog extends DialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        overallHighestGradeTextView = view.findViewById(R.id.activity_record_overview_statisitcs_dialog_OH);
        overallHighestGradeTextView.setText(overallHighestGrade);
        overallLowestGradeTextView = view.findViewById(R.id.activity_record_overview_statisitcs_dialog_OL);
        overallLowestGradeTextView.setText(overallLowestGrade);
        overallAverageGradeTextView = view.findViewById(R.id.activity_record_overview_statisitcs_dialog_OA);
        overallAverageGradeTextView.setText(overallAverageGrade);

        TextView examHighestGradeTextView = view.findViewById(R.id.activity_record_overview_statisitcs_dialog_EH);
        ...
        examAverageGradeTextView = view.findViewById(R.id.activity_record_overview_statisitcs_dialog_EA);
        examAverageGradeTextView.setText(examHighestGrade);

        TextView assignmentHighestTextView = view.findViewById(R.id.activity_record_overview_statisitcs_dialog_AH);
        assignmentHighestTextView.setText(assignmentHighest);
        TextView assignmentLowestTextView = view.findViewById(R.id.activity_record_overview_statisitcs_dialog_AL);
        assignmentLowestTextView.setText(assignmentLowest);
        TextView assignmentAverageTextView= view.findViewById(R.id.activity_record_overview_statisitcs_dialog_AA);
        assignmentAverageTextView.setText(assignmentAverage);

        TextView quizHighestTextView = view.findViewById(R.id.activity_record_overview_statisitcs_dialog_QH);
        quizHighestTextView.setText(quizHighest);
        TextView quizLowestTextView= view.findViewById(R.id.activity_record_overview_statisitcs_dialog_QL);
        quizLowestTextView.setText(quizLowest);
        TextView quizAverageTextView= view.findViewById(R.id.activity_record_overview_statisitcs_dialog_QA);
        quizAverageTextView.setText(quizAverage);

        TextView testHighestTextView= view.findViewById(R.id.activity_record_overview_statisitcs_dialog_TH);
        testHighestTextView.setText(testHighest);
        TextView testLowestTextView= view.findViewById(R.id.activity_record_overview_statisitcs_dialog_TL);
        testLowestTextView.setText(testLowest);
        TextView testAverageTextView= view.findViewById(R.id.activity_record_overview_statisitcs_dialog_TA);
